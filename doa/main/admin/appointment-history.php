...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from queries where id = '".$_GET['id']."'");
...
<?php include('include/sidebar.php');?>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Appointment History (All Appointments)</h1>
								</div>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									...
									<thead>
										...
										<tbody>
											<?php
												$query=mysqli_query($con,"SELECT * FROM queries");
												$cnt=1;
	...
	<a href="appointment-history.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
											...
											<?php 
$cnt=$cnt+1;
											 }  else echo "<h2>Query table is empty</h2>"; } ?>
